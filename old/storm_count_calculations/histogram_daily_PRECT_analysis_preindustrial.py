...
region_lat_idx = geo_idx(LA_lat, PRECT_lat)
region_lon_idx = geo_idx(LA_lon, PRECT_lon)

PRECT_ONDJFM_region = ncfile.variables['PRECT'][time_indices_ONDJFM,LA_lat_idx, LA_lon_idx]*86400.*1000
