...
for lat_idx in range(PRECT_lat.size):
	...
	for lon_idx in range(PRECT_lon.size):
		...
		save_file = 'member_005_latidx_'+'{:02d}'.format(lat_idx)+'_lonidx_'+'{:02d}'.format(lon_idx)+'_years_'+'{:04d}'.format(year_start)+'-'+'{:04d}'.format(year_end)+'_threshold_'+str(threshold)+'mmday_'+region+'_extras.npy'	
