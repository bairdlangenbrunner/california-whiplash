...
for yr_idx in range(year_start_list.size):
	...
	whiplash_ratios_all_df.to_csv('csv_files_ALL_TIME/store_all_whiplash_ratios_dataframe_'+str(hi_perc)+str(lo_perc)+'_'+region+'_'+str(year_start_list[yr_idx])+'-'+str(year_end_list[yr_idx])+'_windowsize_'+str(window)+'.csv')