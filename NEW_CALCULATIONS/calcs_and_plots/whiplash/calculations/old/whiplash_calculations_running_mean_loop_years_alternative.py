...
for latlon_idx in range(len(latlon_indices)):
	...
	for yr_idx in [0]:#range(6):
		...
		whiplash_ratios_all_df.to_csv('store_all_whiplash_ratios_dataframe_'+str(hi_perc)+str(lo_perc)+'_'+region+'_'+str(year_start_list[yr_idx])+'-'+str(year_end_list[yr_idx])+'_windowsize_'+str(window)+'.csv')